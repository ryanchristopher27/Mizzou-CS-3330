...
public class Unzip extends Thread {
    ...
    public void run() {
        ...
        for (File file : files) {
            ...
            try { 
                ...
                doNotify(calculatePercent(numComplete, files.length), 
                            UnzipState.EXCEPTION,
                            "Exception occurred on " + file.getPath() + ": " + ex); 
    ...
    // this method allows a notification handler to be registered to receive notification
    public void setOnNotifiction(Notification notification){
